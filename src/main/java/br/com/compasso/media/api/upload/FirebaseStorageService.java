...
import br.com.compasso.media.api.upload.UploadInput;
        ...
        if (FirebaseApp.getApps().isEmpty()) {
            ...
            if(in != null) {
                FirebaseOptions options = new FirebaseOptions.Builder()
                        ...
                        .setStorageBucket("media-68a49.appspot.com")
                        .setDatabaseUrl("https://media-68a49.firebaseio.com")
                        .build();
...
//        URL signedUrl = blob.signUrl(15, TimeUnit.DAYS);
